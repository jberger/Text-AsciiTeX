...
A C<n>-th root of C<a>, the argument [n] is optional. Without it it produces the square root of C<a>.
...
You can copy and paste some of these examples in the equation input field and hit generate to see what it does.
